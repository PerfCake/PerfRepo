...
//			if (constantParameters.containsKey(paramName)) {
//				paramRegular += delimiter + constantParameters.get(paramName);
//			} else {
//				paramRegular += delimiter + ".*";
//				xParam = paramName;  
//			}			
//		}
//		paramRegular = paramRegular.substring(delimiter.length());
//		XYSeriesCollection dataset = new XYSeriesCollection();        
//		XYSeries series = new XYSeries("SOA ER1");
//		dataset.addSeries(series);
//		for (String key : parameterValues) {
//			if (key.matches(paramRegular)) {
//				TestExecution te = values.get(key);
//				String paramValue = te.getParametersAsMap().get(xParam);
//				if (paramValue != null) {
//					try {
//						double paramValueDouble = Double.parseDouble(paramValue);
//						Value value = getValue(key, metric.getName());
//						if (value != null && value.getResultValue() != null) {
//							series.add(paramValueDouble, value.getResultValue().doubleValue());
//						}
...
//        chartSpec.title = "Parameters: ";
//        chartSpec.xAxisLabel = xParam;
//        chartSpec.yAxisLabel = metric.getName();
...
//			String[] o1a = o1.split(delimiter);
//			String[] o2a = o2.split(delimiter);
//			int compare = 0;
//			for (int i = 0; i < o1a.length; i++) {				
//				try {
//					compare = Double.valueOf(o1a[i]).compareTo(Double.parseDouble(o2a[i]));
//				} catch (Exception e) {
//					compare = o1a[i].compareTo(o2a[i]);
//				}
//				if (compare != 0) {
//					return compare;
//				}
